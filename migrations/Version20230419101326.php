 ...
 */
final class Version20230419101326 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, course_id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, number SMALLINT DEFAULT NULL, PRIMARY KEY(id))');
